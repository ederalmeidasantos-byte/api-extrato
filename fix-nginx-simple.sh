...
# Backup
sudo cp /etc/nginx/sites-available/lunasdigital.com.br /etc/nginx/sites-available/lunasdigital.com.br.backup3
...
if [ $? -eq 0 ]; then
    ...
    sudo cp /etc/nginx/sites-available/lunasdigital.com.br.backup3 /etc/nginx/sites-available/lunasdigital.com.br
fi
