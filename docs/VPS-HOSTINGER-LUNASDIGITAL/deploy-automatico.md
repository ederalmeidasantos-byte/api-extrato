...
#### **Windows (PowerShell) - ATUALIZADO 01/10/2025:**
```bash
# Gerar chave SSH ED25519 (mais segura)
...
### **Deploy Rápido (Recomendado) - ATUALIZADO 01/10/2025**
```bash
# Atualizar código e reiniciar aplicação com nova chave SSH
...
### **Deploy Completo**
```bash
# Deploy com resolução de conflitos e verificação
