// coeficientes-simulador.js
// Coeficientes para simulação de contratos INSS

export const coeficientesSimulador = {
  "1.66": {
...
export function getCoeficienteSimulador(taxa, dia) {
