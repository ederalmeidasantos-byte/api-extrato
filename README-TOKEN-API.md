...
git add api-token-render.js package-render.json README-TOKEN-API.md
git commit -m "feat: Add FGTS Token API for Render"
...
- Logs automáticos no console do Render