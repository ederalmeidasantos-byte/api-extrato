...
console.log('🤖 ChatGPT Vendedor COM CLASSIFICAÇÃO rodando na porta', PORT);
        ...
        if (clienteData.success && clienteData.cliente) {
          ...
          switch (classificacao.acao) {
            ...
            case 'verificar_duvida':
              ...
              if (msgLower.includes('portabilidade')) {
              ...
              } else if (msgLower.includes('fgts')) {
              ...
              } else if (msgLower.includes('taxa')) {
            ...
            default:
              const msgLowerDefault = mensagem.toLowerCase();
              if (msgLowerDefault.includes('portabilidade')) {
