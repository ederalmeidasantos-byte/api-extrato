...
# Script para adicionar sistema de links mascarados
CONTAINER_NAME="api-simulador-lunasdigital"
FILE_PATH="/app/INSS/server-inss.js"

echo "🔧 Adicionando sistema de links mascarados..."

# Adicionar endpoint para criar link temporário antes do endpoint salvar-cliente
...
echo "✅ Sistema de links mascarados adicionado!"
